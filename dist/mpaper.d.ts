...
declare namespace mpaper {
    ...
    class CompoundPath extends PathItem {
         ...
         */
        morphingTo(timeline: any, target: any, duration: any, offset: any, finishCallback: any): void
        ...
        /** 
         * @return -1 if not on the path
         */
        getOffsetOf(point: any, epsilon?: any): void
    ...
    class Curve  {
         ...
         * @param epsilon - the point on the curve
         * 
         * @return the curve location of the specified point
         */
        getLocationOf(point: Point, epsilon?: number): CurveLocation
         ...
         */
        getTimeOf(point: Point, epsilon?: number): number
    ...
    /** 
     * A DecimalNumber item represents
     */
    class DecimalNumber extends TextItem {
    ...
    class Group extends Item {
         ...
         */
        align_grid(numrows: any, numcols: any, gap: any, exclude: any): void
         ...
         */
        align(vertical: any, gap: any, exclude: any): void
    ...
    class Item  {
         ...
         */
        getAllLeaves(groupLevel: any): void
         ...
         * addd updater
         * 
         * @param duration - optional default value = 0. 
         ...
         * @param index - optional    The index at which the new updater should be added in ``self.updaters``.
         *             In case ``index`` is ``None`` the updater will be added at the end.
         * 
         * @return wrapped updater  .
         */
        addUpdater(update_func: Function, duration: number, index: number): this

        /** 
         * show with animation
         */
        showing(duration: any): void

        /** 
         * hide with animation
         */
        hiding(removeIt: any, duration: any): void
         ...
         * @param asTopLayer - the item to be added as a child
         * 
         * @return the added item, or `null` if adding was not possible
         */
        addChild(item: Item, asTopLayer?: boolean): Item
         ...
         */
        addChildren(items: Item[], asTopLayer?: boolean): Item[]
     ...
     * Parameters:
     */
    class LabeledDot extends StyledText {
    ...
    class Layer extends Group {
         ...
         * @param object - an object containing the properties to be set on
         *     the layer
         * @param clips - layer clip area, is a rectangle
         */
        constructor(object: object, clips: Rectangle)
         ...
         *                     }
         * 
         * @param options - duration: default 1 second
         ...
         */
        createItems(timeline: any, options: any, offset: any, doneCallback: any): void
    ...
    /** 
     * The MoveRestriction object is the base class for any of the other updator types,
    ...
    class PaperScope  {
        ...
        DecimalNumber: typeof DecimalNumber
        Event: typeof Event
        ...
        LabeledDot: typeof LabeledDot
        Layer: typeof Layer
        Matrix: typeof Matrix
        MouseEvent: typeof MouseEvent
        MoveRestriction: typeof MoveRestriction
        ...
        PositionControl: typeof PositionControl
        Project: typeof Project
        R9AniWrap: typeof R9AniWrap
        Raster: typeof Raster
        Rectangle: typeof Rectangle
        Segment: typeof Segment
        Shape: typeof Shape
        Size: typeof Size
        SmallIntPicker: typeof SmallIntPicker
        Sprite: typeof Sprite
        SpriteSVG: typeof SpriteSVG
        ...
        TwoStateButton: typeof TwoStateButton
    ...
    class Path extends PathItem {
         ...
         */
        start(duration: any, startAniTime: any, repeat: any, doneCallback: any): void
         ...
         * 
         * @return new points inserted.
         */
        insertExtraSegments(numPoints: any): void
         ...
         * @return the newly created path after splitting, if any
         */
        cloneSubPath(location: number | CurveLocation, end_offset: any): Path

        
        splitAt(location: any): void
         ...
         * 
         * @param point - the point on the path
         * @param epsilon - the point on the path
         * 
         * @return the length of the path up to the specified point
         */
        getOffsetOf(point: Point, epsilon?: number): number
    ...
    namespace Path {
        ...
        class Rectangle extends Path {
             ...
             */
            constructor(rectangle: mpaper.Rectangle, radius?: Size)
        ...
        class Ellipse extends Path {
             ...
             */
            constructor(rectangle: mpaper.Rectangle)
        ...
        class Tex extends Path {
            
            constructor(props: any)

        }

        class Text extends Path {
    ...
    /** 
     * The PositionControl object is the base class for any of the other updator types,
    ...
    /** 
     * The R9AniWrap object represents a scheduled task
     */
    class R9AniWrap  {

        /** 
         * Creates a R9AniWrap object using
         */
        constructor(point: R9AniWrap)
    ...
    class Raster extends Item {
         ...
         */
        morphingTo(timeline: any, target: any, duration: any, offset: any, finishCallback: any, precise: any): void
         ...
         */
        setPixeles(x: any, y: any, width: any, height: any, color: any): void
     ...
     * The SmallIntPicker
     */
    class SmallIntPicker extends Item {

    }

    /** 
     * The Sprite item represents an animated image in a Paper.js project.
    ...
    class Sprite extends Item {
         ...
         * @return the sub raster as a newly created raster item
         */
        getSubRaster(rect: Rectangle): Sprite
    ...
    /** 
     * The SpriteSVG item represents an animated SVG in a Paper.js project.
     * it can has several states
     * 
     *    * @example 
    ...
    /** 
     * The Studio object refers to a workspace. it includes both canvas and html dom div
    ...
    /** 
     * A StyledText item represents a piece of typography in your Paper.js
     * project which starts from a certain point and extends by the amount of
     * characters contained in it.
     * 
     * Note for animation type:
     * 
     * @param animType - //0 : static text, 1: show text increasely 2: use text as background  3: use underline as animation 
     *     //4: karaoka    5: manim-style  6: manim-style2 
     * 
     *      0 static, 1 writing, 2 rewriting, 3 underline, 4 karaoka,  5 manim
     */
    class StyledText extends TextItem {
    ...
    class Toolbar extends Item {
         ...
         */
        register_tool(toolInfo: any): void
     ...
     * The TwoStateButton
     */
    class TwoStateButton extends Item {

    }

    /** 
     * The Updater object is the base class for any of the other updator types,
     * such as {@link MoveRestriction},
     */
    class Updater  {
...
declare module 'mpaper/dist/mpaper-core'
{
    const paperCore: Pick<mpaper.PaperScope, Exclude<keyof mpaper.PaperScope, 'PaperScript'>>;
    export = paperCore
}

declare module 'mpaper'
{
    const paperFull: mpaper.PaperScope;
    export = paperFull
}
