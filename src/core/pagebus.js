...
/**
 * modified for R9 project... the original purpose is to shared by multiple R9 instance at the same page.
 * 
 * for now ,we will use it for communication 
 * 1.  betwwen paperjs and regular javascript code 
 * 2.  inside paperjs
 * 3.  inside generated code from r9 project
 * 
 * 
 */
