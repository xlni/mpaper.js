...
// environment. We can't do this directly in src/mpaper.js, due to the nature of
...
// Set up a local `window` variable valid across the full the mpaper.js scope,
...
// to the mpaper.js function scope, and this is the one that is modified here.
