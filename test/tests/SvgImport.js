...
test('Import SVG line', function() {
    ...
    var imported = mpaper.project.importSVG(createSVG('line', attrs));
...
test('Import SVG rect', function() {
    ...
    var imported = mpaper.project.importSVG(createSVG('rect', attrs),
            { expandShapes: true });
...
test('Import SVG ellipse', function() {
    ...
    var imported = mpaper.project.importSVG(createSVG('ellipse', attrs),
            { expandShapes: true });
...
test('Import SVG circle', function() {
    ...
    var imported = mpaper.project.importSVG(createSVG('circle', attrs),
            { expandShapes: true });
...
test('Import SVG polygon', function() {
    ...
    var imported = mpaper.project.importSVG(createSVG('polygon', {
        points: points
    }));
...
test('Import SVG polyline', function() {
    ...
    var imported = mpaper.project.importSVG(createSVG('polyline', {
        points: points
    }));
    var path = createPolyPath(points);
    equals(imported, path);
...
test('Import SVG Image', function(assert) {
    ...
    var imported = mpaper.project.importSVG(svg);
